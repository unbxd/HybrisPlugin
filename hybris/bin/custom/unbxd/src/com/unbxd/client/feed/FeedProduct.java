...
public class FeedProduct implements InputDocument {
	...
	public void addField(IndexedProperty var1, Object var2) throws FieldValueProviderException {
		...
		addField(var1, var2, null);

	};

	protected void addInternalField(String fieldName, Object value) {
		if (!(fieldName.startsWith("autosuggest") || fieldName.startsWith("spellcheck")
				|| fieldName.contains("sortable"))) {
	...
	public void addField(String fieldName, Object value) {
		if (fieldName.contains(USED_SEPARATOR) && !fieldName.contains("sortable")) {
			addInternalField(StringUtils.substringBefore(fieldName, USED_SEPARATOR), value);
		} else {
			addInternalField(fieldName, value);
		}
	}

	@Override
	public void addField(IndexedProperty var1, Object var2, String var3) throws FieldValueProviderException {
		if (var3 != null && var1.isCurrency()) {
			addInternalField(var1.getName() + "_" + var3, var2);
		} else {
			addInternalField(var1.getName(), var2);
		}
	};
