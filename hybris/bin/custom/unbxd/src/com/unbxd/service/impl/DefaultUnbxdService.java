...
public class DefaultUnbxdService implements UnbxdService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultUnbxdService.class);
	...
	{
		return DefaultUnbxdService.class.getResourceAsStream("/unbxd/sap-hybris-platform.png");
	}
