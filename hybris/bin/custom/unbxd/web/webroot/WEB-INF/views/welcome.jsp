...
<html>
<head>
    <title>Welcome to unbxd</title>
    <link rel="stylesheet" href="<c:url value="/static/unbxd-webapp.css"/>" type="text/css"
...
<div class="container">
    ...
    <div>
        ...
        <ul>
            <li><b>resources/unbxd-items.xml</b> - here you can model your items</li>
            <li><b>resources/unbxd-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/unbxd-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/unbxd-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/unbxd-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
