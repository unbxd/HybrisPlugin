...
var unbxdSearchInit = function(jQuery, Handlebars) {
    ...
    jQuery.extend(Unbxd.setSearch.prototype, {
        ...
        getHostNPath: function() {
            ...
            var host = "//search.unbxdapi.com/";
            if (this.options.platform === 'io') {
                host = "//search.unbxd.io/";
            }
            return host + this.options.APIKey + "/" + this.options.siteName + "/" + handler;
        },
        ...
        url: function() {
            ...
            if (this.options.type == "search" && this.params['query'] != undefined) {
                url += '&variants=true&' + this.options.searchQueryParam + '=' + encodeURIComponent(this.params.query);
            ...
            if (this.options.facetMultiSelect)
                nonhistoryPath += '&facet.multiselect=true&facet.field=allCategories&facet.field=gender&facet.field=categoryName&facet.field=color&facet.field=size';
