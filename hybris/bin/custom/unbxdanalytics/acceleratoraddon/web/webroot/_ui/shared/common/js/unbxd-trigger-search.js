...
window.searchobj = new window.Unbxd.setSearch({
    ...
    searchResultSetTemp: {
        ...
        '<img id="img-{{uniqueId}}" src="https://34.226.87.236:9002/yacceleratorstorefront{{{[img-300Wx300H]}}}" alt="{{{name.[0]}}}" title="{{{name.[0]}}}"></a>',
        '<div class="details">',
        '<a class="name" href="{{url}}">{{name.[0]}}</a>',
        '{{#isSwatches}}',
        ...
        '<button class="btn btn-default btn-block js-pickup-in-store-button glyphicon glyphicon-map-marker" id="product_{{code}}" type="button submit" data-productcart="{{#if (isdefined priceValue) }}&pound;{{priceValue}}{{else}}&pound;0.00{{/if}}" data-productcart-variants="{}" data-img-html="<img src=&quot;https://34.226.87.236:9002/yacceleratorstorefront{{{[img-300Wx300H]}}}&quot;/>" data-productname-html="{{{name.[0]}}}"  data-cartpage="false" data-entrynumber="{{@index}}" data-actionurl="{{url}}" data-value="1"></button>',
        '</div>',
        ...
        "list": ['{{#products}}<li class="product__list--item">',
            ...
            '<img src="https://34.226.87.236:9002/yacceleratorstorefront{{{[img-300Wx300H]}}}" alt="{{{name.[0]}}} title="{{{name.[0]}}}">',
            '</a>',
            '<a href="{{url}}" id="{sku}}" class="product__list--name"  unbxdParam_sku="{{uniqueId}}" unbxdParam_pRank="{{unbxdprank}}" unbxdAttr="product">', '{{{name.[0]}}}', '</a>',
