    ...
    if(unbxdAutoSuggestSiteKey && unbxdAutoSuggestApiKey && $("#"+unbxdAutoSuggestSearchInputId)) {
        ...
        window.searchobj = new window.Unbxd.setSearch({
            ...
            onIntialResultLoad: function (obj) {
                ...
                jQuery(".unbxd-search-results").show();
            ...
            onNoResult: function(obj){
                jQuery(".unbxd-search-results").html("\t\t\t\t<div class=\"yCmsContentSlot side-content-slot cms_disp-img_slot searchEmptyPageTop\">\n" +
